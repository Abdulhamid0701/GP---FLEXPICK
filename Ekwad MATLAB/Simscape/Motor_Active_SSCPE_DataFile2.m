...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [125.49997999149613 14.991498186703978 4.9999999999999964];  % mm
smiData.RigidTransform(2).angle = 3.1415926535897931;  % rad
smiData.RigidTransform(2).axis = [-1 -1.7499616709548524e-33 1.5676073306914777e-17];
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [-5.4624867638685091 -29.530402749429793 0];  % mm
smiData.RigidTransform(5).angle = 3.1415926535897931;  % rad
smiData.RigidTransform(5).axis = [-2.775557561562892e-17 1 0];
smiData.RigidTransform(5).ID = "RootGround[motor_mount-1]";
...
smiData.RevoluteJoint(1).Rz.Pos = -117.02684775002928;  % deg
smiData.RevoluteJoint(1).ID = "[NEMA344-1:-:Active Arm 5.0-1]";
